...
import com.survey.shuvo.technodhaka.tdsurvey.RegNAssgProgSrv;
import com.survey.shuvo.technodhaka.tdsurvey.data_model.GraduationGridDataModel;
import com.survey.shuvo.technodhaka.tdsurvey.data_model.ServiceDataModel;
import com.survey.shuvo.technodhaka.tdsurvey.utils.UtilClass;

import static com.survey.shuvo.technodhaka.tdsurvey.DBHelper.SQLiteHandler.*;
import static com.survey.shuvo.technodhaka.tdsurvey.activity.DTResponseRecordingActivity.COMMUNITY_GROUP;
import static com.survey.shuvo.technodhaka.tdsurvey.activity.DTResponseRecordingActivity.COMMUNITY_GROUP_IG;
import static com.survey.shuvo.technodhaka.tdsurvey.activity.DTResponseRecordingActivity.COMMUNITY_GROUP_LG;
import static com.survey.shuvo.technodhaka.tdsurvey.activity.DTResponseRecordingActivity.COMMUNITY_GROUP_MG;
import static com.survey.shuvo.technodhaka.tdsurvey.activity.DTResponseRecordingActivity.COMMUNITY_GROUP_PG;
import static com.survey.shuvo.technodhaka.tdsurvey.activity.DTResponseRecordingActivity.COMMUNITY_GROUP_WE;
import static com.survey.shuvo.technodhaka.tdsurvey.activity.DTResponseRecordingActivity.DISTRIBUTION_POINT;
import static com.survey.shuvo.technodhaka.tdsurvey.activity.DTResponseRecordingActivity.GEO_LAYER_1;
import static com.survey.shuvo.technodhaka.tdsurvey.activity.DTResponseRecordingActivity.GEO_LAYER_2;
import static com.survey.shuvo.technodhaka.tdsurvey.activity.DTResponseRecordingActivity.GEO_LAYER_3;
import static com.survey.shuvo.technodhaka.tdsurvey.activity.DTResponseRecordingActivity.GEO_LAYER_4;
import static com.survey.shuvo.technodhaka.tdsurvey.activity.DTResponseRecordingActivity.GEO_LAYER_ADDRESS;
import static com.survey.shuvo.technodhaka.tdsurvey.activity.DTResponseRecordingActivity.LOOKUP_LIST;
import static com.survey.shuvo.technodhaka.tdsurvey.activity.DTResponseRecordingActivity.ORGANIZATION_LIST;
import static com.survey.shuvo.technodhaka.tdsurvey.activity.DTResponseRecordingActivity.SERVICE_SITE;
...
public class SQLiteQuery {
    ...
    public static String getUpzillaJoinQuery(String countryCode, String districtCode) {
        return " JOIN " + SELECTED_VILLAGE_TABLE +
                " ON " + SQLiteHandler.UPAZILLA_TABLE + "." + COUNTRY_CODE_COL + " = " + SELECTED_VILLAGE_TABLE + "." + COUNTRY_CODE_COL +
                " AND " + SQLiteHandler.UPAZILLA_TABLE + "." + LAY_R1_LIST_CODE_COL + " = " + SELECTED_VILLAGE_TABLE + "." + LAY_R1_LIST_CODE_COL +
                " AND " + SQLiteHandler.UPAZILLA_TABLE + "." + LAY_R2_LIST_CODE_COL + " = " + SELECTED_VILLAGE_TABLE + "." + LAY_R2_LIST_CODE_COL +
                ...
                SQLiteHandler.UPAZILLA_TABLE + "." + LAY_R2_LIST_CODE_COL + ", " + SQLiteHandler.UPAZILLA_TABLE + "." + UPZILLA_NAME_COL;
    }

    public static String getUnionJoinQuery(String countryCode, String districtCode, String upzellaCode) {
        return " JOIN " + SELECTED_VILLAGE_TABLE +
                " ON " + UNIT_TABLE + "." + COUNTRY_CODE_COL + " = " + SELECTED_VILLAGE_TABLE + "." + COUNTRY_CODE_COL +
                " AND " + UNIT_TABLE + "." + LAY_R1_LIST_CODE_COL + " = " + SELECTED_VILLAGE_TABLE + "." + LAY_R1_LIST_CODE_COL +
                " AND " + UNIT_TABLE + "." + LAY_R2_LIST_CODE_COL + " = " + SELECTED_VILLAGE_TABLE + "." + LAY_R2_LIST_CODE_COL +
                " AND " + UNIT_TABLE + "." + LAY_R3_LIST_CODE_COL + " = " + SELECTED_VILLAGE_TABLE + "." + LAY_R3_LIST_CODE_COL +
    ...
    public static String getDistrictJoinQuery(String countryCode) {
        return " JOIN " + SELECTED_VILLAGE_TABLE +
                " ON " + SQLiteHandler.DISTRICT_TABLE + "." + COUNTRY_CODE_COL + " = " + SELECTED_VILLAGE_TABLE + "." + COUNTRY_CODE_COL +
                " AND " + SQLiteHandler.DISTRICT_TABLE + "." + LAY_R1_LIST_CODE_COL + " = " + SELECTED_VILLAGE_TABLE + "." + LAY_R1_LIST_CODE_COL +
                " WHERE " + SQLiteHandler.DISTRICT_TABLE + "." + COUNTRY_CODE_COL + "='" + countryCode + "' GROUP BY " + SQLiteHandler.DISTRICT_TABLE + "." + LAY_R1_LIST_CODE_COL + ", " + SQLiteHandler.DISTRICT_TABLE + "." + DISTRICT_NAME_COL;
    ...
    public static String getSingleMemberForAssign_sql(String cCode, String dstCode, String upCode, String unCode, String vCode, String hhid, String memberId, String donorCode, String awardCode, String prgCode, String srvCode) {
        ...
        return "SELECT " + REGISTRATION_MEMBER_TABLE + "." + HHID_COL
                ...
                + ", " + SERVICE_MASTER_TABLE + "." + SQLiteHandler.SERVICE_NAME_COL + "  AS AssignCriteria "
...
*/
                ...
                " AND " + REGISTRATION_TABLE + "." + DISTRICT_NAME_COL + " = " + REGISTRATION_MEMBER_TABLE + "." + DISTRICT_NAME_COL +
                " AND " + REGISTRATION_TABLE + "." + UPZILLA_NAME_COL + " = " + REGISTRATION_MEMBER_TABLE + "." + UPZILLA_NAME_COL +
                " AND " + REGISTRATION_TABLE + "." + UNITE_NAME_COL + " = " + REGISTRATION_MEMBER_TABLE + "." + UNITE_NAME_COL +
                " AND " + REGISTRATION_TABLE + "." + VILLAGE_NAME_COL + " = " + REGISTRATION_MEMBER_TABLE + "." + VILLAGE_NAME_COL +
                " AND " + REGISTRATION_TABLE + "." + PID_COL + " = " + REGISTRATION_MEMBER_TABLE + "." + HHID_COL + " " +
                " LEFT JOIN " + RELATION_TABLE + " ON " + RELATION_TABLE + "." + SQLiteHandler.RELATION_CODE + " = " + REGISTRATION_MEMBER_TABLE + "." + SQLiteHandler.RELATION_COL +
                ...
                + " regMemGrp." + COUNTRY_CODE_COL + " = " + REGISTRATION_MEMBER_TABLE + "." + COUNTRY_CODE_COL
                + " AND  regMemGrp." + LAY_R1_LIST_CODE_COL + " = " + REGISTRATION_MEMBER_TABLE + "." + DISTRICT_NAME_COL
                + " AND  regMemGrp." + LAY_R2_LIST_CODE_COL + " = " + REGISTRATION_MEMBER_TABLE + "." + UPZILLA_NAME_COL
                + " AND  regMemGrp." + LAY_R3_LIST_CODE_COL + " = " + REGISTRATION_MEMBER_TABLE + "." + UNITE_NAME_COL
                + " AND  regMemGrp." + LAY_R4_LIST_CODE_COL + " = " + REGISTRATION_MEMBER_TABLE + "." + VILLAGE_NAME_COL
                ...
                + " AND  regMemGrp." + HH_MEM_ID + " = " + REGISTRATION_MEMBER_TABLE + "." + HH_MEM_ID
...
*/
    ...
    public static String getMemberListView_searchBy_ID_sql(final String cCode, final String dstCode, final String upCode, final String unCode, final String vCode, final String memberSearchId) {
        ...
        return "SELECT " + REGISTRATION_MEMBER_TABLE + "." + HHID_COL
                ...
                + ", " + REGISTRATION_MEMBER_TABLE + "." + VILLAGE_NAME_COL
                + ", " + REGISTRATION_TABLE + "." + PNAME_COL
                + " , " + VILLAGE_TABLE + "." + VILLAGE_NAME_COL + " AS layR4Name "
...
//
                ...
                + " ON " + RELATION_TABLE + "." + SQLiteHandler.RELATION_CODE + " = " + REGISTRATION_MEMBER_TABLE + "." + SQLiteHandler.RELATION_COL
                + " left JOIN " + VILLAGE_TABLE + " ON "

                + REGISTRATION_TABLE + "." + COUNTRY_CODE_COL + " = " + VILLAGE_TABLE + "." + COUNTRY_CODE_COL
                + " AND " + REGISTRATION_TABLE + "." + DISTRICT_NAME_COL + " = " + VILLAGE_TABLE + "." + LAY_R1_LIST_CODE_COL
                + " AND " + REGISTRATION_TABLE + "." + UPZILLA_NAME_COL + " = " + VILLAGE_TABLE + "." + LAY_R2_LIST_CODE_COL
                + " AND " + REGISTRATION_TABLE + "." + UNITE_NAME_COL + " = " + VILLAGE_TABLE + "." + LAY_R3_LIST_CODE_COL
                + " AND " + REGISTRATION_TABLE + "." + VILLAGE_NAME_COL + " = " + VILLAGE_TABLE + "." + LAY_R4_LIST_CODE_COL

                + " LEFT JOIN " + SQLiteHandler.LUP_REGN_ADDRESS_LOOKUP_TABLE
                + " ON " + SQLiteHandler.LUP_REGN_ADDRESS_LOOKUP_TABLE + "." + COUNTRY_CODE_COL + " = " + REGISTRATION_MEMBER_TABLE + "." + COUNTRY_CODE_COL

                + " AND " + SQLiteHandler.LUP_REGN_ADDRESS_LOOKUP_TABLE + "." + LAY_R1_LIST_CODE_COL + " = " + REGISTRATION_TABLE + "." + DISTRICT_NAME_COL
                + " AND  " + SQLiteHandler.LUP_REGN_ADDRESS_LOOKUP_TABLE + "." + LAY_R2_LIST_CODE_COL + " = " + REGISTRATION_TABLE + "." + UPZILLA_NAME_COL
                + " AND  " + SQLiteHandler.LUP_REGN_ADDRESS_LOOKUP_TABLE + "." + LAY_R3_LIST_CODE_COL + " = " + REGISTRATION_TABLE + "." + UNITE_NAME_COL
                + " AND  " + SQLiteHandler.LUP_REGN_ADDRESS_LOOKUP_TABLE + "." + LAY_R4_LIST_CODE_COL + " = " + REGISTRATION_TABLE + "." + VILLAGE_NAME_COL
                ...
                // group by
                + " GROUP BY " + REGISTRATION_MEMBER_TABLE + "." + DISTRICT_NAME_COL + " , "
                + REGISTRATION_MEMBER_TABLE + "." + UPZILLA_NAME_COL + " , "
                + REGISTRATION_MEMBER_TABLE + "." + UNITE_NAME_COL + " , "
                + REGISTRATION_MEMBER_TABLE + "." + VILLAGE_NAME_COL + " , "
                + REGISTRATION_MEMBER_TABLE + "." + HHID_COL + " , "
...
//
    ...
    public static String getMemberGraduationStatusList_sql(String cCode, String donorCode, String awardCode, String programCode, String srvCode, String memberId) {
        ...
        if (cCode.equals("0004")) {
            ...
            getMemberName = REGISTRATION_MEMBER_TABLE + "." + MEM_NAME_COL;


        return "SELECT " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + HHID_COL +
                " , " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + HH_MEM_ID +
                ...
                " , " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + GRD_DATE_COL +
                ...
                + " AND " + SQLiteHandler.GRD_CODE_COL + " = " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + SQLiteHandler.GRD_CODE_COL
                + " ) AS GRDTitle "
                + " , " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + LAY_R1_LIST_CODE_COL
                + " || '' || " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + LAY_R2_LIST_CODE_COL
                + " || '' || " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + LAY_R3_LIST_CODE_COL
                ...
                + " || '' || " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + HH_MEM_ID + " AS nMemId "
//                "
                ...
                + REG_N_ASSIGN_PROG_SRV_TABLE + "." + COUNTRY_CODE_COL + " = " + VILLAGE_TABLE + "." + COUNTRY_CODE_COL
                + " AND " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + COUNTRY_CODE_COL + " = " + VILLAGE_TABLE + "." + COUNTRY_CODE_COL
                + " AND " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + LAY_R1_LIST_CODE_COL + " = " + VILLAGE_TABLE + "." + LAY_R1_LIST_CODE_COL
                ...
                + " WHERE " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + COUNTRY_CODE_COL + " = '" + cCode + "'"
                ...
                + " || '' || " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + LAY_R4_LIST_CODE_COL
                + " || '' || " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + HHID_COL
                + " || '' || " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + HH_MEM_ID + " LIKE  '%" + memberId + "%' "
    ...
    public static String getSingleLiberiaMemberDataQuery(String country, String district, String upazilla, String union, String village, String household, String member) {
        ...
        return "SELECT  "
                ...
                " AND " + DISTRICT_NAME_COL + "='" + district + "' " +
                " AND " + UPZILLA_NAME_COL + "='" + upazilla + "' " +
                " AND " + UNITE_NAME_COL + "='" + union + "' " +
                " AND " + VILLAGE_NAME_COL + "='" + village + "' " +
    ...
    public static String getDeletedMemberIDQuery(int memberId) {
        return "SELECT "
                ...
                + HHID_COL + " , "
                + HH_MEM_ID + "  "
                + " FROM " + REGISTRATION_MEMBER_TABLE
    ...
    public static String getFFAMemberListForServiceSelectQuery(String country, String donor,
        ...
        return "SELECT  " +
                ...
                " FROM " + SERVICE_TABLE
                + " WHERE "
                + COUNTRY_CODE_COL + " = " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + COUNTRY_CODE_COL
                + " AND " + DONOR_CODE_COL + " = " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + DONOR_CODE_COL
                + " AND " + AWARD_CODE_COL + " = " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + AWARD_CODE_COL
                + " AND " + HHID_COL + " = " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + HHID_COL
                + " AND " + HH_MEM_ID + " = " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + HH_MEM_ID
                + " AND " + PROGRAM_CODE_COL + " = " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + PROGRAM_CODE_COL
                + " AND " + SERVICE_CODE_COL + " = " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + SERVICE_CODE_COL
                ...
                + " , IFNULL(" + SERVICE_TABLE + "." + SQLiteHandler.WORK_DAY_COL + ",'0') AS WD"
                ...
                + " INNER JOIN " +
                REGISTRATION_TABLE
                + " ON " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + COUNTRY_CODE_COL + " = " + REGISTRATION_TABLE + "." + COUNTRY_CODE_COL
                + " AND " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + LAY_R1_LIST_CODE_COL + " = " + REGISTRATION_TABLE + "." + DISTRICT_NAME_COL
                + " AND " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + LAY_R2_LIST_CODE_COL + " = " + REGISTRATION_TABLE + "." + UPZILLA_NAME_COL
                + " AND " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + LAY_R3_LIST_CODE_COL + " = " + REGISTRATION_TABLE + "." + UNITE_NAME_COL
                + " AND " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + LAY_R4_LIST_CODE_COL + " = " + REGISTRATION_TABLE + "." + VILLAGE_NAME_COL
                ...
                + " LEFT JOIN "
                + SERVICE_TABLE + " ON "
                + SERVICE_TABLE + "." + COUNTRY_CODE_COL + " = " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + COUNTRY_CODE_COL
                + " AND " + SERVICE_TABLE + "." + DONOR_CODE_COL + " = " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + DONOR_CODE_COL
                + " AND " + SERVICE_TABLE + "." + AWARD_CODE_COL + " = " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + AWARD_CODE_COL
                + " AND " + SERVICE_TABLE + "." + LAY_R1_LIST_CODE_COL + " = " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + LAY_R1_LIST_CODE_COL
                + " AND " + SERVICE_TABLE + "." + LAY_R2_LIST_CODE_COL + " = " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + LAY_R2_LIST_CODE_COL
                + " AND " + SERVICE_TABLE + "." + LAY_R3_LIST_CODE_COL + " = " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + LAY_R3_LIST_CODE_COL
                + " AND " + SERVICE_TABLE + "." + LAY_R4_LIST_CODE_COL + " = " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + LAY_R4_LIST_CODE_COL
                + " AND " + SERVICE_TABLE + "." + HHID_COL + " = " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + HHID_COL
                + " AND " + SERVICE_TABLE + "." + HH_MEM_ID + " = " + REGISTRATION_MEMBER_TABLE + "." + HH_MEM_ID
                + " AND " + SERVICE_TABLE + "." + PROGRAM_CODE_COL + " = " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + PROGRAM_CODE_COL
                + " AND " + SERVICE_TABLE + "." + SERVICE_CODE_COL + " = " + REG_N_ASSIGN_PROG_SRV_TABLE + "." + SERVICE_CODE_COL
                ...
                REG_N_ASSIGN_PROG_SRV_TABLE + "." + SERVICE_CODE_COL + " = '" + service + "' AND " +
...
// for test
    ...
    public static String getDistributionGridShowData(String countryCode, String donorCode, String awardCode, String progCode, String serviceOpMonthCode, String fdpCode, String memberId) {
        return "SELECT "
                + SERVICE_TABLE + "." + COUNTRY_CODE_COL + " AS country , "
                + SERVICE_TABLE + "." + DONOR_CODE_COL + " AS donor , "
                + SERVICE_TABLE + "." + AWARD_CODE_COL + " AS award , "
                + SERVICE_TABLE + "." + LAY_R1_LIST_CODE_COL + " AS district , "
                ...
                + SERVICE_TABLE + "." + PROGRAM_CODE_COL + " AS program , "
                + SERVICE_TABLE + "." + SERVICE_CODE_COL + " AS service , "
                + SERVICE_MASTER_TABLE + "." + SERVICE_SHORT_NAME_COL + " AS srvName , "

                + SERVICE_TABLE + "." + LAY_R1_LIST_CODE_COL + " || "
                ...
                + SERVICE_TABLE + "." + HH_MEM_ID + " AS MEMBERID , "
                + REGISTRATION_TABLE + "." + PNAME_COL + " AS HhName , "
                + REGISTRATION_MEMBER_TABLE + "." + MEM_NAME_COL + " AS MemName , "
                + SERVICE_TABLE + "." + OP_MONTH_CODE_COL + " , "
                + SERVICE_TABLE + "." + SQLiteHandler.SERVICE_CENTER_CODE_COL + " ,  "
                + SERVICE_TABLE + "." + SQLiteHandler.WORK_DAY_COL + " AS wd  "
                ...
                + " FROM " + SERVICE_TABLE + "  INNER JOIN " + SQLiteHandler.COUNTRY_PROGRAM_TABLE + " ON  "
                + SERVICE_TABLE + "." + COUNTRY_CODE_COL + " = " + SQLiteHandler.COUNTRY_PROGRAM_TABLE + "." + COUNTRY_CODE_COL
                + " AND " + SERVICE_TABLE + "." + DONOR_CODE_COL + " = " + SQLiteHandler.COUNTRY_PROGRAM_TABLE + "." + DONOR_CODE_COL
                + " AND " + SERVICE_TABLE + "." + AWARD_CODE_COL + " = " + SQLiteHandler.COUNTRY_PROGRAM_TABLE + "." + AWARD_CODE_COL
                + " AND " + SERVICE_TABLE + "." + PROGRAM_CODE_COL + " = " + SQLiteHandler.COUNTRY_PROGRAM_TABLE + "." + PROGRAM_CODE_COL
                + " AND " + SERVICE_TABLE + "." + SERVICE_CODE_COL + " = " + SQLiteHandler.COUNTRY_PROGRAM_TABLE + "." + SERVICE_CODE_COL
                + " INNER JOIN " + REGISTRATION_TABLE + " ON "
                + SERVICE_TABLE + "." + COUNTRY_CODE_COL + " || "
                + SERVICE_TABLE + "." + LAY_R1_LIST_CODE_COL + " || "
                + SERVICE_TABLE + "." + LAY_R2_LIST_CODE_COL + " || "
                + SERVICE_TABLE + "." + LAY_R3_LIST_CODE_COL + " || "
                + SERVICE_TABLE + "." + LAY_R4_LIST_CODE_COL + " || "
                ...
                + REGISTRATION_TABLE + "." + DISTRICT_NAME_COL + " || "
                + REGISTRATION_TABLE + "." + UPZILLA_NAME_COL + " || "
                + REGISTRATION_TABLE + "." + UNITE_NAME_COL + " || "
                + REGISTRATION_TABLE + "." + VILLAGE_NAME_COL + " || "
                + REGISTRATION_TABLE + "." + PID_COL
                + " INNER JOIN " + REGISTRATION_MEMBER_TABLE + " ON "
                + SERVICE_TABLE + "." + COUNTRY_CODE_COL + " = " + REGISTRATION_MEMBER_TABLE + "." + COUNTRY_CODE_COL
                + " AND " + SERVICE_TABLE + "." + LAY_R1_LIST_CODE_COL + " = " + REGISTRATION_MEMBER_TABLE + "." + DISTRICT_NAME_COL
                + " AND " + SERVICE_TABLE + "." + LAY_R2_LIST_CODE_COL + " = " + REGISTRATION_MEMBER_TABLE + "." + UPZILLA_NAME_COL
                + " AND " + SERVICE_TABLE + "." + LAY_R3_LIST_CODE_COL + " = " + REGISTRATION_MEMBER_TABLE + "." + UNITE_NAME_COL
                + " AND " + SERVICE_TABLE + "." + LAY_R4_LIST_CODE_COL + " = " + REGISTRATION_MEMBER_TABLE + "." + VILLAGE_NAME_COL
                + " AND " + SERVICE_TABLE + "." + HHID_COL + " = " + REGISTRATION_MEMBER_TABLE + "." + HHID_COL
                + " AND " + SERVICE_TABLE + "." + HH_MEM_ID + " = " + REGISTRATION_MEMBER_TABLE + "." + HH_MEM_ID
                + " INNER JOIN " + SERVICE_MASTER_TABLE
                + " ON " + SERVICE_TABLE + "." + PROGRAM_CODE_COL + " = " + SERVICE_MASTER_TABLE + "." + PROGRAM_CODE_COL
                + " AND " + SERVICE_TABLE + "." + SERVICE_CODE_COL + " = " + SERVICE_MASTER_TABLE + "." + SERVICE_CODE_COL
...
*/
                ...
                " ) "
                + " AND " + SERVICE_TABLE + "." + COUNTRY_CODE_COL + " = '" + countryCode + "' "
                ...
                + " AND (" + SERVICE_TABLE + "." + SQLiteHandler.DISTRIBUTION_STATUS_COL + " IN ( 'S', 'P' )) "
                + " AND  " + SERVICE_TABLE + "." + SQLiteHandler.DIST_DATE_COL + " = 'null' "

                + " AND (" + SERVICE_TABLE + "." + SQLiteHandler.SERVICE_CENTER_CODE_COL + " IN ( SELECT "
                ...
                /**  id Searching  with 15 digit*/
                + " AND " + SERVICE_TABLE + "." + LAY_R1_LIST_CODE_COL + " || \"\" || " +
                SERVICE_TABLE + "." + LAY_R2_LIST_CODE_COL + " || \"\" || " +
                SERVICE_TABLE + "." + LAY_R3_LIST_CODE_COL + " || \"\" || " +
                SERVICE_TABLE + "." + LAY_R4_LIST_CODE_COL + " || \"\" || " +
                SERVICE_TABLE + "." + HHID_COL + " || \"\" || " +
                SERVICE_TABLE + "." + HH_MEM_ID
                + " LIKE '%" + memberId + "%' "
    ...
    public static String getDistributionStatusFromDistributionTableQuery(String countryCode, String donorCode, String awardCode, String districtCode, String upzillaCode, String uniteCode, String villageCode, String programCode, String srviceCode, String distMonthCode, String fdpCode, final String distFlag, String id) {
        String sql = "SELECT CASE WHEN " + SQLiteHandler.DISTRIBUTION_STATUS_COL + " IS NULL THEN '-' ELSE " + SQLiteHandler.DISTRIBUTION_STATUS_COL + " END   AS " + SQLiteHandler.DISTRIBUTION_STATUS_COL
                ...
                + " AND " + SQLiteHandler.DISTRIBUTION_TABLE + "." + DIST_FLAG_COL + " = '" + distFlag + "' "
    ...
    public static String getSingleHouseHoldDataForLiberiaQuery(String countryCode, String districtCode, String upzellaCode, String unitCode, String villageCode, String houseHoldId) {
        return " SELECT " +
               /* SQLiteHandler.COUNTRY_CODE_COL + " , " +
                ...
                " AND " + DISTRICT_NAME_COL + " = '" + districtCode + "' " +
                " AND " + UPZILLA_NAME_COL + " = '" + upzellaCode + "' " +
                " AND " + UNITE_NAME_COL + " = '" + unitCode + "'" +
                " AND " + VILLAGE_NAME_COL + " = '" + villageCode + "' " +
                " AND " + PID_COL + " = '" + houseHoldId + "' ";
    }
...
// havet use it
    ...
    public static String get_RegNAssProgSrvRegistrationDateRangeSelectQuery(String cCode) {
        return "SELECT " + USA_START_DATE + " , " + USA_END_DATE + " FROM " + OP_MONTH_TABLE +
                " WHERE " + COUNTRY_CODE_COL + " = '" + cCode + "' " +
                " AND " + OPERATION_CODE_COL + " = '" + SQLiteHandler.REGISTRATION_OP_CODE + "' " +
...
/*    public static String getTotalListOfMemberRAssignedSummary_sql(String countryCode, String districtCode, String upzellaCode, String unionCode, String villageCode, String donorCode, String awardCord, String programCode, String srvCode) {
    ...
    public static String get_SrvCriteriaList_SelectQuery(String cCode, String donorCode, String awardCord, String opMCode, String programCode, String distFlag) {
        return " SELECT " + SERVICE_MASTER_TABLE + "." + SERVICE_SHORT_NAME_COL + " AS Criteria , " +
                ...
                " WHERE " + SERVICE_TABLE + "." + PROGRAM_CODE_COL + " = " + SERVICE_MASTER_TABLE + "." + PROGRAM_CODE_COL +
                " AND " + SERVICE_TABLE + "." + SERVICE_CODE_COL + " = " + SERVICE_MASTER_TABLE + "." + SERVICE_CODE_COL
                + " AND " + SERVICE_TABLE + "." + OP_MONTH_CODE_COL + " = " + OP_MONTH_TABLE + "." + OP_MONTH_CODE_COL
                + " AND " + SERVICE_TABLE + "." + SQLiteHandler.SERVICE_STATUS_COL + " = 'O'"

                + " ) AS Count " +

                " FROM " + SERVICE_TABLE + " JOIN " + SQLiteHandler.SERVICE_CENTER_TABLE
                + " ON " + SERVICE_TABLE + "." + COUNTRY_CODE_COL + " = " + SQLiteHandler.SERVICE_CENTER_TABLE + "." + COUNTRY_CODE_COL +

                " JOIN " + OP_MONTH_TABLE + " ON " + SERVICE_TABLE + "." + COUNTRY_CODE_COL + " = " + OP_MONTH_TABLE + "." + COUNTRY_CODE_COL
                + " AND " + SERVICE_TABLE + "." + OPERATION_CODE_COL + " = " + OP_MONTH_TABLE + "." + OPERATION_CODE_COL
                + " AND " + SERVICE_TABLE + "." + OP_MONTH_CODE_COL + " = " + OP_MONTH_TABLE + "." + OP_MONTH_CODE_COL
                + " AND " + SERVICE_TABLE + "." + DONOR_CODE_COL + " = " + OP_MONTH_TABLE + "." + DONOR_CODE_COL
                + " AND " + SERVICE_TABLE + "." + AWARD_CODE_COL + " = " + OP_MONTH_TABLE + "." + AWARD_CODE_COL + " " +

                " JOIN " + SERVICE_MASTER_TABLE + " ON " + SERVICE_TABLE + "." + PROGRAM_CODE_COL + " = " + SERVICE_MASTER_TABLE + "." + PROGRAM_CODE_COL + " AND " +

                SERVICE_TABLE + "." + SERVICE_CODE_COL + " = " + SERVICE_MASTER_TABLE + "." + SERVICE_CODE_COL +

                " WHERE  " + SERVICE_TABLE + "." + COUNTRY_CODE_COL + " = '" + cCode + "' "
                + " AND " + SERVICE_TABLE + "." + DONOR_CODE_COL + " = '" + donorCode + "' "
                + " AND " + SERVICE_TABLE + "." + AWARD_CODE_COL + " = '" + awardCord + "'"
                + " AND " + SERVICE_TABLE + "." + OP_MONTH_CODE_COL + " = '" + opMCode + "'  "
                + " AND " + SERVICE_TABLE + "." + PROGRAM_CODE_COL + " = '" + programCode + "' "
    ...
    public static String get_DistCriteriaList_SelectQuery(String cCode, String donorCode, String awardCord, String opMCode, String programCode, String distFlag) {
       ...
       /* ,( Select Count(*) From Service  WHERE Service.ProgramCode = ServiceMaster.ProgramCode
        ...
        and Service.DistributionStatus in('S','P') ) as plane*/
                ...
                + " AND " + SERVICE_TABLE + "." + SQLiteHandler.SERVICE_STATUS_COL + " = 'C' "
                + " AND " + SERVICE_TABLE + "." + SQLiteHandler.DISTRIBUTION_STATUS_COL + " IN ('S','P') ) AS plan "


                + " ,  ( SELECT COUNT (*) FROM " + SQLiteHandler.DISTRIBUTION_TABLE
                + " WHERE " + SQLiteHandler.DISTRIBUTION_TABLE + "." + PROGRAM_CODE_COL + " = " + SERVICE_MASTER_TABLE + "." + PROGRAM_CODE_COL
                + " AND " + SQLiteHandler.DISTRIBUTION_TABLE + "." + SERVICE_CODE_COL + " = " + SERVICE_MASTER_TABLE + "." + SERVICE_CODE_COL
                + " AND " + SQLiteHandler.DISTRIBUTION_TABLE + "." + OP_MONTH_CODE_COL + " = " + OP_MONTH_TABLE + "." + OP_MONTH_CODE_COL
                ...
                + " JOIN " + OP_MONTH_TABLE
                + " ON " + SQLiteHandler.DISTRIBUTION_TABLE + "." + COUNTRY_CODE_COL + " = " + OP_MONTH_TABLE + "." + COUNTRY_CODE_COL
                + " AND " + SQLiteHandler.DISTRIBUTION_TABLE + "." + DONOR_CODE_COL + " = " + OP_MONTH_TABLE + "." + DONOR_CODE_COL
                + " AND " + SQLiteHandler.DISTRIBUTION_TABLE + "." + AWARD_CODE_COL + " = " + OP_MONTH_TABLE + "." + AWARD_CODE_COL + " "
                + " AND " + OP_MONTH_TABLE + "." + OPERATION_CODE_COL + " = '3' "
                + " AND " + SQLiteHandler.DISTRIBUTION_TABLE + "." + OP_MONTH_CODE_COL + " = " + OP_MONTH_TABLE + "." + OP_MONTH_CODE_COL

                + " JOIN " + SERVICE_MASTER_TABLE
                + " ON " + SQLiteHandler.DISTRIBUTION_TABLE + "." + PROGRAM_CODE_COL + " = " + SERVICE_MASTER_TABLE + "." + PROGRAM_CODE_COL
                + " AND " + SQLiteHandler.DISTRIBUTION_TABLE + "." + SERVICE_CODE_COL + " = " + SERVICE_MASTER_TABLE + "." + SERVICE_CODE_COL +
    ...
    public static String getTotalServiceAttendanceSummary_SelectQuery(String cCode, String donorCode, String awardCord, String opMCode, String prgCode, String srvCode, String distFlag) {
        ...
        return " SELECT " + SERVICE_TABLE + "." + LAY_R1_LIST_CODE_COL + " || '' || " +
                SERVICE_TABLE + "." + LAY_R2_LIST_CODE_COL + " || '' || " +
                SERVICE_TABLE + "." + LAY_R3_LIST_CODE_COL + " || '' || " +
                SERVICE_TABLE + "." + LAY_R4_LIST_CODE_COL + " || '' || " +
                SERVICE_TABLE + "." + HHID_COL + " || '' || " +
                SERVICE_TABLE + "." + HH_MEM_ID + " AS NewID , " +
                /** HERE COUNT THE SERVICE */


                SERVICE_TABLE + "." + SQLiteHandler.SERVICE_SL_COL
                + " , " + getMemName + " AS memberName "
                + " , " + SERVICE_TABLE + "." + SQLiteHandler.SERVICE_STATUS_COL + " AS status " +
                //   SERVICE_TABLE + "." + SERVICE_DT_COL +
                " FROM " + SERVICE_TABLE +
                " JOIN " + SQLiteHandler.SERVICE_CENTER_TABLE + " ON " + SERVICE_TABLE + "." + COUNTRY_CODE_COL + " = " + SQLiteHandler.SERVICE_CENTER_TABLE + "." + COUNTRY_CODE_COL +
                ...
                " AND " + SERVICE_TABLE + "." + DONOR_CODE_COL + " = " + OP_MONTH_TABLE + "." + DONOR_CODE_COL +
                " AND " + SERVICE_TABLE + "." + AWARD_CODE_COL + " = " + OP_MONTH_TABLE + "." + AWARD_CODE_COL + "  " +
                " JOIN " + SERVICE_MASTER_TABLE + " ON " + SERVICE_TABLE + "." + PROGRAM_CODE_COL + " = " + SERVICE_MASTER_TABLE + "." + PROGRAM_CODE_COL +
                " AND " + SERVICE_TABLE + "." + SERVICE_CODE_COL + " = " + SERVICE_MASTER_TABLE + "." + SERVICE_CODE_COL + "  " +
                " INNER JOIN " + REGISTRATION_MEMBER_TABLE +
                " ON " + REGISTRATION_MEMBER_TABLE + "." + COUNTRY_CODE_COL + " = " + SERVICE_TABLE + "." + COUNTRY_CODE_COL +
                " AND " + REGISTRATION_MEMBER_TABLE + "." + DISTRICT_NAME_COL + " = " + SERVICE_TABLE + "." + LAY_R1_LIST_CODE_COL +
                " AND " + REGISTRATION_MEMBER_TABLE + "." + UPZILLA_NAME_COL + " = " + SERVICE_TABLE + "." + LAY_R2_LIST_CODE_COL +
                " AND " + REGISTRATION_MEMBER_TABLE + "." + UNITE_NAME_COL + " = " + SERVICE_TABLE + "." + LAY_R3_LIST_CODE_COL +
                " AND " + REGISTRATION_MEMBER_TABLE + "." + VILLAGE_NAME_COL + " = " + SERVICE_TABLE + "." + LAY_R4_LIST_CODE_COL +


                " AND " + REGISTRATION_MEMBER_TABLE + "." + HHID_COL + " = " + SERVICE_TABLE + "." + HHID_COL +

                " AND " + REGISTRATION_MEMBER_TABLE + "." + HH_MEM_ID + " = " + SERVICE_TABLE + "." + HH_MEM_ID +

                " WHERE " + SERVICE_TABLE + "." + COUNTRY_CODE_COL + " = '" + cCode + "'" +
                " AND " + SERVICE_TABLE + "." + DONOR_CODE_COL + " = '" + donorCode + "'" +
                " AND " + SERVICE_TABLE + "." + AWARD_CODE_COL + " = '" + awardCord + "'" +
                " AND " + SERVICE_TABLE + "." + PROGRAM_CODE_COL + " = '" + prgCode + "'" +
                " AND " + SERVICE_TABLE + "." + SERVICE_CODE_COL + " = '" + srvCode + "'" +
                " AND " + SERVICE_TABLE + "." + OP_MONTH_CODE_COL + " = '" + opMCode + "'  " +
                " AND " + SERVICE_TABLE + "." + DIST_FLAG_COL + " = '" + distFlag + "'  " +
                " AND " + SERVICE_TABLE + "." + SQLiteHandler.SERVICE_STATUS_COL + " = 'O'  " +
                " GROUP BY " + SERVICE_TABLE + "." + LAY_R1_LIST_CODE_COL + " , " +
                SERVICE_TABLE + "." + LAY_R2_LIST_CODE_COL + " , " +
                SERVICE_TABLE + "." + LAY_R3_LIST_CODE_COL + " , " +
                SERVICE_TABLE + "." + LAY_R4_LIST_CODE_COL + " , " +
                SERVICE_TABLE + "." + HHID_COL + " , " +
 ...
 */
        ...
        return " SELECT " + SQLiteHandler.DISTRIBUTION_TABLE + "." + MEM_ID_15_D_COL + " AS NewID "
                ...
                + " THEN " + getMemName
                + " ELSE " + REGISTRATION_TABLE + "." + PNAME_COL + " END AS rptName "
                ...
                + " ON " + REGISTRATION_MEMBER_TABLE + "." + COUNTRY_CODE_COL + " = " + SQLiteHandler.DISTRIBUTION_TABLE + "." + COUNTRY_CODE_COL
                + " AND " + REGISTRATION_MEMBER_TABLE + "." + DISTRICT_NAME_COL
                + " || " + REGISTRATION_MEMBER_TABLE + "." + UPZILLA_NAME_COL
                + " || " + REGISTRATION_MEMBER_TABLE + "." + UNITE_NAME_COL
                + " || " + REGISTRATION_MEMBER_TABLE + "." + VILLAGE_NAME_COL
                + " || " + REGISTRATION_MEMBER_TABLE + "." + HHID_COL
                + " || " + REGISTRATION_MEMBER_TABLE + "." + HH_MEM_ID + " = " + SQLiteHandler.DISTRIBUTION_TABLE + "." + MEM_ID_15_D_COL


                + " LEFT JOIN " + REGISTRATION_TABLE
                + " ON " + REGISTRATION_TABLE + "." + COUNTRY_CODE_COL + " = " + SQLiteHandler.DISTRIBUTION_TABLE + "." + COUNTRY_CODE_COL
                + " AND " + REGISTRATION_TABLE + "." + DISTRICT_NAME_COL
                + " || " + REGISTRATION_TABLE + "." + UPZILLA_NAME_COL
                + " || " + REGISTRATION_TABLE + "." + UNITE_NAME_COL
                + " || " + REGISTRATION_TABLE + "." + VILLAGE_NAME_COL
                + " || " + REGISTRATION_TABLE + "." + PID_COL
    ...
    public static String getTotal_Service_Itemize_AttendanceSummary_SelectQuery(String cCode, String donorCode, String awardCord, String opMCode, String prgCode/*, String srvCode*/, String vouItSpec) {
        return " SELECT " + SERVICE_EXTENDED_TABLE + "." + LAY_R1_LIST_CODE_COL + " || '' || "
                ...
                " JOIN " + OP_MONTH_TABLE + " ON " + SERVICE_EXTENDED_TABLE + "." + COUNTRY_CODE_COL + " = " + OP_MONTH_TABLE + "." + COUNTRY_CODE_COL +
                ...
                " AND " + SERVICE_EXTENDED_TABLE + "." + DONOR_CODE_COL + " = " + OP_MONTH_TABLE + "." + DONOR_CODE_COL +
                " AND " + SERVICE_EXTENDED_TABLE + "." + AWARD_CODE_COL + " = " + OP_MONTH_TABLE + "." + AWARD_CODE_COL + "  " +
                " JOIN " + SERVICE_MASTER_TABLE + " ON " + SERVICE_EXTENDED_TABLE + "." + PROGRAM_CODE_COL + " = " + SERVICE_MASTER_TABLE + "." + PROGRAM_CODE_COL +
                " AND " + SERVICE_EXTENDED_TABLE + "." + SERVICE_CODE_COL + " = " + SERVICE_MASTER_TABLE + "." + SERVICE_CODE_COL + "  " +
...
//                + " , " +               SERVICE_EXTENDED_TABLE + "." + SERVICE_SL_COL + "  ";
    ...
    public static String getTotal_Distribution_Itemize_AttendanceSummary_SelectQuery(String cCode, String donorCode, String awardCord, String opMCode, String prgCode/*, String srvCode*/, String vouItSpec) {
        return " SELECT "
                ...
                " JOIN " + OP_MONTH_TABLE + " ON " + DISTRIBUTION_EXTENDED_TABLE + "." + COUNTRY_CODE_COL + " = " + OP_MONTH_TABLE + "." + COUNTRY_CODE_COL +
                //" AND " + SERVICE_EXTENDED_TABLE + "." + OPERATION_CODE_COL + " = " + OP_MONTH_TABLE + "." + OPERATION_CODE_COL +
                " AND " + DISTRIBUTION_EXTENDED_TABLE + "." + OP_MONTH_CODE_COL + " = " + OP_MONTH_TABLE + "." + OP_MONTH_CODE_COL +
                " AND " + DISTRIBUTION_EXTENDED_TABLE + "." + DONOR_CODE_COL + " = " + OP_MONTH_TABLE + "." + DONOR_CODE_COL +
                " AND " + DISTRIBUTION_EXTENDED_TABLE + "." + AWARD_CODE_COL + " = " + OP_MONTH_TABLE + "." + AWARD_CODE_COL + "  " +
                " JOIN " + SERVICE_MASTER_TABLE + " ON " + DISTRIBUTION_EXTENDED_TABLE + "." + PROGRAM_CODE_COL + " = " + SERVICE_MASTER_TABLE + "." + PROGRAM_CODE_COL +
                " AND " + DISTRIBUTION_EXTENDED_TABLE + "." + SERVICE_CODE_COL + " = " + SERVICE_MASTER_TABLE + "." + SERVICE_CODE_COL + "  " +
                " INNER JOIN " + SQLiteHandler.VOUCHER_COUNTRY_PROGRAM_ITEM_TABLE +
                " ON " + DISTRIBUTION_EXTENDED_TABLE + "." + COUNTRY_CODE_COL + " = " + SQLiteHandler.VOUCHER_COUNTRY_PROGRAM_ITEM_TABLE + "." + COUNTRY_CODE_COL +
                " AND  " + DISTRIBUTION_EXTENDED_TABLE + "." + DONOR_CODE_COL + " = " + SQLiteHandler.VOUCHER_COUNTRY_PROGRAM_ITEM_TABLE + "." + DONOR_CODE_COL +
                " AND  " + DISTRIBUTION_EXTENDED_TABLE + "." + AWARD_CODE_COL + " = " + SQLiteHandler.VOUCHER_COUNTRY_PROGRAM_ITEM_TABLE + "." + AWARD_CODE_COL +
...
//
    ...
    public static String getRegisteredData_ifVillageExt_SelectQuery(String ext_village, String hhId) {
        ...
        String sql = "SELECT "
                ...
                + SQLiteHandler.DISTRICT_TABLE + "." + DISTRICT_NAME_COL + ", "
                + SQLiteHandler.UPAZILLA_TABLE + "." + UPZILLA_NAME_COL + ","
                ...
                + " AND " + REGISTRATION_TABLE + "." + DISTRICT_NAME_COL + "=" + SQLiteHandler.DISTRICT_TABLE + "." + LAY_R1_LIST_CODE_COL
                + " LEFT JOIN " + SQLiteHandler.UPAZILLA_TABLE
                + " ON " + REGISTRATION_TABLE + "." + COUNTRY_CODE_COL + "=" + SQLiteHandler.UPAZILLA_TABLE + "." + COUNTRY_CODE
                + " AND " + REGISTRATION_TABLE + "." + DISTRICT_NAME_COL + "=" + SQLiteHandler.UPAZILLA_TABLE + "." + LAY_R1_LIST_CODE_COL
                + " AND " + REGISTRATION_TABLE + "." + UPZILLA_NAME_COL + "=" + SQLiteHandler.UPAZILLA_TABLE + "." + LAY_R2_LIST_CODE_COL
                + " LEFT JOIN " + UNIT_TABLE
                + " ON " + REGISTRATION_TABLE + "." + COUNTRY_CODE_COL + "=" + UNIT_TABLE + "." + COUNTRY_CODE
                + " AND " + REGISTRATION_TABLE + "." + DISTRICT_NAME_COL + "=" + UNIT_TABLE + "." + LAY_R1_LIST_CODE_COL
                + " AND " + REGISTRATION_TABLE + "." + UPZILLA_NAME_COL + "=" + UNIT_TABLE + "." + LAY_R2_LIST_CODE_COL
                + " AND " + REGISTRATION_TABLE + "." + UNITE_NAME_COL + "=" + UNIT_TABLE + "." + LAY_R3_LIST_CODE_COL
                + " LEFT JOIN " + VILLAGE_TABLE
                + " ON " + REGISTRATION_TABLE + "." + COUNTRY_CODE_COL + "=" + VILLAGE_TABLE + "." + COUNTRY_CODE
                + " AND " + REGISTRATION_TABLE + "." + DISTRICT_NAME_COL + "=" + VILLAGE_TABLE + "." + LAY_R1_LIST_CODE_COL
                + " AND " + REGISTRATION_TABLE + "." + UPZILLA_NAME_COL + "=" + VILLAGE_TABLE + "." + LAY_R2_LIST_CODE_COL
                + " AND " + REGISTRATION_TABLE + "." + UNITE_NAME_COL + "=" + VILLAGE_TABLE + "." + LAY_R3_LIST_CODE_COL
                + " AND " + REGISTRATION_TABLE + "." + VILLAGE_NAME_COL + "=" + VILLAGE_TABLE + "." + LAY_R4_LIST_CODE_COL
                ...
                + " AND " + REGISTRATION_TABLE + "." + DISTRICT_NAME_COL + "=" + SQLiteHandler.LUP_REGN_ADDRESS_LOOKUP_TABLE + "." + LAY_R1_LIST_CODE_COL
                + " AND " + REGISTRATION_TABLE + "." + UPZILLA_NAME_COL + "=" + SQLiteHandler.LUP_REGN_ADDRESS_LOOKUP_TABLE + "." + LAY_R2_LIST_CODE_COL
                + " AND " + REGISTRATION_TABLE + "." + UNITE_NAME_COL + "=" + SQLiteHandler.LUP_REGN_ADDRESS_LOOKUP_TABLE + "." + LAY_R3_LIST_CODE_COL
                + " AND " + REGISTRATION_TABLE + "." + VILLAGE_NAME_COL + "=" + SQLiteHandler.LUP_REGN_ADDRESS_LOOKUP_TABLE + "." + LAY_R4_LIST_CODE_COL
                ...
                + REGISTRATION_TABLE + "." + UPZILLA_NAME_COL + " || '' || "
                + REGISTRATION_TABLE + "." + UNITE_NAME_COL + " || '' || "
                + REGISTRATION_TABLE + "." + VILLAGE_NAME_COL + " = '" + ext_village + "' "
                + " AND " + REGISTRATION_TABLE + "." + PID_COL + " LIKE '%" + hhId + "%' "
    ...
    public static String getSingleRegisteredData_sql(String cCode, String layR1Code, String layR2Code, String layR3Code, String layR4Code, final String hhId) {
        ...
        return "SELECT "
                ...
                + REGISTRATION_TABLE + "." + DISTRICT_NAME_COL + " = '" + layR1Code + "' AND "
                + REGISTRATION_TABLE + "." + UPZILLA_NAME_COL + " = '" + layR2Code + "' AND "
                + REGISTRATION_TABLE + "." + UNITE_NAME_COL + " = '" + layR3Code + "' AND "
                + REGISTRATION_TABLE + "." + VILLAGE_NAME_COL + " = '" + layR4Code + "'   "
                + " AND " + REGISTRATION_TABLE + "." + PID_COL + " = '" + hhId + "' ";
    ...
    public static String getRegisteredData_ifVillageExt_SearchByName_sql(String ext_village, String hhName) {
        ...
        return "SELECT "
                ...
                + REGISTRATION_TABLE + "." + UNITE_NAME_COL + " || '' || "
                + REGISTRATION_TABLE + "." + VILLAGE_NAME_COL + " = '" + ext_village + "' "
                + " AND " + REGISTRATION_TABLE + "." + PNAME_COL + " LIKE '%" + hhName + "%' "
                + " GROUP BY " + REGISTRATION_TABLE + "." + SQLiteHandler.ID_COL /// this GROUP BY PREVENT TO SHOW DUPLICATED VALUES // Faisal Mohammad  @email:nirzon192@gmail.com @email:nirzon192@gmail.com @email:nirzon192@gmail.com @email:nirzon192@gmail.commodify
                + " ORDER BY " + REGISTRATION_TABLE + "." + SQLiteHandler.ID_COL + " DESC";
        //   Log.d("MAR",sql);
        // return sql;
    ...
    public static String getServiceDateRange_selectQuery(String cCode, String srvOpMonthCode) {
        return "SELECT  " + OPERATION_CODE_COL
                + " , " + OP_MONTH_CODE_COL
                + " , " + USA_START_DATE
                + " , " + USA_END_DATE
    ...
    public static String getProgramGraduationDateOfMember_sql(String cCode, String disCode, String upCode, String unCode, String vCode, String hhID, String memID, String donorCode, String awardCode, String progCode) {
        return "SELECT  MAX( " + GRD_DATE_COL + " )  AS grdDate"
                + " FROM " + REG_N_ASSIGN_PROG_SRV_TABLE
                + " WHERE " + COUNTRY_CODE_COL + " = '" + cCode + "' "
    ...
    public static String loadVillageInAssignSummary_sql(String cCode) {
        return "SELECT " + " v." + COUNTRY_CODE_COL + " || '' ||  v." + LAY_R1_LIST_CODE_COL + " || '' || v." + LAY_R2_LIST_CODE_COL + " || '' || v." +
                ...
                + " AND " + "r." + DISTRICT_NAME_COL + "= v." + LAY_R1_LIST_CODE_COL
                + " AND " + "r." + UPZILLA_NAME_COL + "= v." + LAY_R2_LIST_CODE_COL
                + " AND " + "r." + UNITE_NAME_COL + "= v." + LAY_R3_LIST_CODE_COL
                + " AND " + "r." + VILLAGE_NAME_COL + "= v." + LAY_R4_LIST_CODE_COL +
    ...
    public static String getIdListInGroupInGroupSummary_sql(String cCode, String donorCode, String awardCode, String prgCode, String grpCode) {
        ...
        String getMemberName;
        if (cCode.equals("0004")) {
            getMemberName = " regMem." + MEM_NAME_FIRST_COL +
                    "|| ' ' || " + " regMem." + MEM_NAME_MIDDLE_COL +
                    "|| ' ' || " + " regMem." + MEM_NAME_LAST_COL;

        } else
            getMemberName = " regMem." + MEM_NAME_COL;
        return "SELECT " +
        ...
        switch (opMode) {
            case UtilClass.SERVICE_OPERATION_MODE:
                criteria = "SELECT  CASE " + FDP_CODE_COL + " WHEN  'null'  THEN '000'  ELSE " + FDP_CODE_COL + " END " + " || '' || " + SERVICE_CENTER_CODE_COL + " , " +
                        ...
                        + SELECTED_SERVICE_CENTER_TABLE + "." + COUNTRY_CODE_COL + " from " + SELECTED_SERVICE_CENTER_TABLE + ")"
    ...
    public static String loadDynamicSpinnerListLoader_sql(String cCode, String resLupText, String lup_TableName, DynamicDataIndexDataModel dyBasic) {
        ...
        switch (resLupText) {
            ...
            case GEO_LAYER_3:
                ...
                udf = "SELECT " + UNIT_TABLE + "." + LAY_R3_LIST_CODE_COL
                        + ", " + UNIT_TABLE + "." + UNITE_NAME_COL
                        + " FROM " + UNIT_TABLE
                        + " WHERE " + UNIT_TABLE + "." + COUNTRY_CODE_COL + "='" + cCode + "'";


                break;
            case GEO_LAYER_2:
                udf = "SELECT " + SQLiteHandler.UPAZILLA_TABLE + "." + LAY_R2_LIST_CODE_COL
                        + ", " + SQLiteHandler.UPAZILLA_TABLE + "." + UPZILLA_NAME_COL
                        + " FROM " + SQLiteHandler.UPAZILLA_TABLE
                        + " WHERE " + SQLiteHandler.UPAZILLA_TABLE + "." + COUNTRY_CODE_COL + "='" + cCode + "'";
            ...
            case GEO_LAYER_1:
                ...
                udf = "SELECT " + SQLiteHandler.DISTRICT_TABLE + "." + LAY_R1_LIST_CODE_COL
                        + ", " + SQLiteHandler.DISTRICT_TABLE + "." + DISTRICT_NAME_COL
                        + " FROM " + SQLiteHandler.DISTRICT_TABLE
                        + " WHERE " + SQLiteHandler.DISTRICT_TABLE + "." + COUNTRY_CODE_COL + "='" + cCode + "'";
            ...
            case GEO_LAYER_4:
                ...
                udf = "SELECT " + VILLAGE_TABLE + "." + LAY_R4_LIST_CODE_COL
                        + ", " + VILLAGE_TABLE + "." + VILLAGE_NAME_COL
                        + " FROM " + VILLAGE_TABLE
                        + " WHERE " + VILLAGE_TABLE + "." + COUNTRY_CODE_COL + "='" + cCode + "'";
            ...
            case GEO_LAYER_ADDRESS:
                ...
                udf = "SELECT " + SQLiteHandler.LUP_REGN_ADDRESS_LOOKUP_TABLE + "." + SQLiteHandler.REGN_ADDRESS_LOOKUP_CODE_COL
                        ...
                        + " FROM " + SQLiteHandler.LUP_REGN_ADDRESS_LOOKUP_TABLE
                        + " WHERE " + SQLiteHandler.LUP_REGN_ADDRESS_LOOKUP_TABLE + "." + COUNTRY_CODE_COL + "='" + cCode + "'";
            ...
            case SERVICE_SITE:
                ...
                udf = "SELECT " + SQLiteHandler.SERVICE_CENTER_TABLE + "." + SQLiteHandler.SERVICE_CENTER_CODE_COL
                        ...
                        + " WHERE " + SQLiteHandler.SERVICE_CENTER_TABLE + "." + COUNTRY_CODE_COL + "='" + cCode + "'";
            ...
            case DISTRIBUTION_POINT:
                ...
                udf = "SELECT " + SQLiteHandler.FDP_MASTER_TABLE + "." + FDP_CODE_COL
                        + ", " + SQLiteHandler.FDP_MASTER_TABLE + "." + SQLiteHandler.FDP_NAME_COL
                        + " FROM " + SQLiteHandler.FDP_MASTER_TABLE
                        + " WHERE " + SQLiteHandler.FDP_MASTER_TABLE + "." + COUNTRY_CODE_COL + "='" + cCode + "'";
            ...
            case LOOKUP_LIST:
                ...
                udf = "SELECT " + SQLiteHandler.DT_LUP_TABLE + "." + SQLiteHandler.LIST_CODE_COL
                        ...
                        + " WHERE " + SQLiteHandler.DT_LUP_TABLE + "." + COUNTRY_CODE_COL + "= '" + cCode + "' "
        ...
        switch (appOpMode) {
            case UtilClass.REGISTRATION_OPERATION_MODE:
                sql = " INNER JOIN " + SELECTED_VILLAGE_TABLE + " ON "
                        + SQLiteHandler.COUNTRY_TABLE + "." + COUNTRY_CODE_COL + " = "
            ...
            case UtilClass.DISTRIBUTION_OPERATION_MODE:
                sql = " INNER JOIN " + SQLiteHandler.SELECTED_FDP_TABLE + " ON "
                        + SQLiteHandler.COUNTRY_TABLE + "." + COUNTRY_CODE_COL + " = "
                        + SQLiteHandler.SELECTED_FDP_TABLE + "." + COUNTRY_CODE_COL;

                break;
            case UtilClass.SERVICE_OPERATION_MODE:
                sql = " INNER JOIN " + SQLiteHandler.SELECTED_SERVICE_CENTER_TABLE + " ON "
                        + SQLiteHandler.COUNTRY_TABLE + "." + COUNTRY_CODE_COL + " = "
                        + SQLiteHandler.SELECTED_SERVICE_CENTER_TABLE + "." + COUNTRY_CODE_COL;
            ...
            case UtilClass.OTHER_OPERATION_MODE:
                ...
                if (multipleCountryAccessUserFlag) {
                    sql = " INNER JOIN " + SQLiteHandler.SELECTED_COUNTRY_TABLE + " ON "
                            + SQLiteHandler.COUNTRY_TABLE + "." + COUNTRY_CODE_COL + " = "
                            + SQLiteHandler.SELECTED_COUNTRY_TABLE + "." + COUNTRY_CODE_COL;
                    ...
                    sql = " INNER JOIN " + SQLiteHandler.STAFF_GEO_INFO_ACCESS_TABLE + " AS staffAcces ON "
                            + SQLiteHandler.COUNTRY_TABLE + "." + COUNTRY_CODE_COL + " = " + "staffAcces." + COUNTRY_CODE_COL
                            + " WHERE (" + SQLiteHandler.BTN_NEW_COL + " = '1' " +
                            " OR " + SQLiteHandler.BTN_SAVE_COL + " = 1" +
                            " OR " + SQLiteHandler.BTN_DEL_COL + " = 1 ) GROUP BY " + " staffAcces." + COUNTRY_CODE_COL;
