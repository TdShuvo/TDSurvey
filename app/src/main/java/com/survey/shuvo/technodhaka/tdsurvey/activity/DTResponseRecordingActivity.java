...
import com.survey.shuvo.technodhaka.tdsurvey.ADNotificationManager;
import com.survey.shuvo.technodhaka.tdsurvey.DBHelper.DTQResModeDataModel;
import com.survey.shuvo.technodhaka.tdsurvey.DBHelper.DTResponseTableDataModel;
import com.survey.shuvo.technodhaka.tdsurvey.DBHelper.DT_ATableDataModel;
...
import com.survey.shuvo.technodhaka.tdsurvey.DBHelper.SQLServerSyntaxGenerator;
import com.survey.shuvo.technodhaka.tdsurvey.DBHelper.SQLiteHandler;
import com.survey.shuvo.technodhaka.tdsurvey.R;
import com.survey.shuvo.technodhaka.tdsurvey.SpinnerHelper;
import com.survey.shuvo.technodhaka.tdsurvey.SpinnerLoader;
import com.survey.shuvo.technodhaka.tdsurvey.perser.Parse;
import com.survey.shuvo.technodhaka.tdsurvey.utils.CameraUtils;
...
import static com.survey.shuvo.technodhaka.tdsurvey.utils.CameraUtils.CAMERA_REQUEST_1;
        ...
        if (mQusIndex < totalQuestion) {
            ...
            alertDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    dialog.cancel();
                    dialogManager.deleteResponseConfirmationDialog(DTResponseRecordingActivity.this, dyIndex.getDtBasicCode(), dyIndex.getcCode(), dyIndex.getDonorCode(), dyIndex.getAwardCode(), dyIndex.getProgramCode(), dyIndex.getOpMode(), dyIndex.getOpMonthCode(), "0001", mDTRSeq, sqlH);
                }
            });
...
//                    saveData("");
    ...
    private void nextQuestion() {
        ...
        if (mQusIndex < totalQuestion) {
            ...
            mSyntaxGenerator.setDTEnuID("0001");
    ...
    private void initialWithFirstQues() {
        ...
        surveyNumber = sqlH.getSurveyNumber(dyIndex.getDtBasicCode(), dyIndex.getcCode(), dyIndex.getDonorCode(), dyIndex.getAwardCode(), dyIndex.getProgramCode(), "0001");

        // set question index to zero
        mQusIndex = 0;
        mDTRSeq = sqlH.getNextDTResponseSequence(dyIndex.getDtBasicCode(), dyIndex.getcCode(), dyIndex.getDonorCode(), dyIndex.getAwardCode(), dyIndex.getProgramCode(), "0001");
 ...
 */
        DTResponseTableDataModel loadAns = sqlH.getDTResponseTableData(dyIndex.getDtBasicCode(), dyIndex.getcCode(), dyIndex.getDonorCode(), dyIndex.getAwardCode(), dyIndex.getProgramCode(), "0001", mDTQ.getDtQCode(), mDTATableList.get(0).getDt_ACode(), mDTRSeq);
    ...
    private void loadDynamicCheckBox(List<DT_ATableDataModel> dtA_Table_Data) {
        ...
        for (int i = 0; i < dtA_Table_Data.size(); i++) {
            ...
            DTResponseTableDataModel loadAns = sqlH.getDTResponseTableData(dyIndex.getDtBasicCode(), dyIndex.getcCode(), dyIndex.getDonorCode(), dyIndex.getAwardCode(), dyIndex.getProgramCode(), "0001", mDTQ.getDtQCode(), dtA_Table_Data.get(i).getDt_ACode(), mDTRSeq);
            if (loadAns != null) {
 ...
 */
            DTResponseTableDataModel loadAns = sqlH.getDTResponseTableData(dyIndex.getDtBasicCode(), dyIndex.getcCode(), dyIndex.getDonorCode(), dyIndex.getAwardCode(), dyIndex.getProgramCode(), "0001", mDTQ.getDtQCode(), List_DtATable.get(i).getDt_ACode(), mDTRSeq);
            if (loadAns != null) {
                rdbtn.setChecked(true);
